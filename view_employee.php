...
<div class="card card-outline card-primary">
            ...
            <div class="row">
                <div class="col-md-6">
                    <dl>
                        ...
                        <dt class="text-info">Date Hired:</dt>
    ...
    <div class="card-footer text-center">
            <button class="btn btn-pill btn-sn btn-success" type="button" id="print"><i class="fa fa-print"></i> Print</button>
            <a class="btn btn-pill btn-sn btn-dark" href="<?php echo base_url."admin?page=employee" ?>">Back to List</a>
    </div>
</div>
<script>
    $(function(){
        $('#print').click(function(){
            ...
            _el.append('<div class="d-flex justify-content-center">'+
                      ...
                      '<h5 class="text-center">45 Imelda St. Nagkaisang Nayon Nova QC</h5>'+
