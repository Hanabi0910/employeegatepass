...
<div class="card card-outline card-primary">
                ...
                <div class="col-md-12">
                    <fieldset class="border-bottom border-info">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-4">
                                <label for="dob" class="control-label text-info">Date Hired</label>
    ...
    <div class="card-footer text-center">
        <button class="btn btn-pill btn-sn btn-success" type="submit" form="employee-form">Save</button>
        <a class="btn btn-pill btn-sn btn-danger" href="<?php echo base_url."admin?page=employee" ?>">Cancel</a>
    </div>
</div>
<script>
    $(function(){
