...
<div class="card card-outline card-primary">
	<div class="card-header">
        ...
        <div class="card-tools">
			<button type="button" class="btn btn-pill btn-success" id="print"><span class="fas fa-print"></span>  Print</button>
		</div>
	</div>
	<div class="card-body">
		<fieldset>
			...
			<form action="" id="filter-data">
				<div class="row align-items-end">
					...
					<div class="col-md-4">
						<div class="form-group">
							<button class="btn btn-pill btn-sm btn-primary"><i class="fa fa-filter"></i> Filter</button>
						</div>
					</div>
				</div>
			</form>
                        ...
                        ?>
                            <tr>
								...
								<td class="text-center">
									<?php if($row['type'] == 1): ?>
										<span class="badge badge-primary rounded-pill">Time In</span>
									<?php else: ?>
										<span class="badge badge-danger rounded-pill">Time Out</span>
									<?php endif; ?>
								</td>
                            </tr>
                        <?php endwhile; ?>
